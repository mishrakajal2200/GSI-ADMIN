...
>
  {/* Header */}
  <header className="bg-white/90 backdrop-blur-sm shadow-lg p-4 flex items-center justify-between sticky top-0 z-40 rounded-b-3xl border-b border-gray-100">
    <button
      className="p-2 rounded-md text-gray-600 hover:bg-gray-100 transition-colors duration-200 lg:hidden" // Only show on smaller screens if sidebar is hidden

...
// //     try {
// //       await axios.patch(`https://gsi-backend-1.onrender.com/api/auth/${id}/role`, { role: newRole });
...
//   const handleBlockToggle = async (id, isBlocked) => {
//     try {
//      await axios.patch(`https://gsi-backend-1.onrender.com/api/auth/${id}/status`, { isBlocked: !isBlocked });
...
//             <p className="text-gray-500 text-sm">You can add form inputs here to actually update the name/email.</p>
//             <button
//               onClick={() => setEditingUser(null)}
//               className="mt-4 bg-gray-700 text-white px-4 py-2 rounded hover:bg-gray-800"
//             >
